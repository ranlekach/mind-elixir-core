...
const qe = function(e) {
  ...
  for (let h = 0; h < l.length; h++) {
    const p = l[h], m = p.firstChild, g = m.offsetTop, f = m.offsetLeft, v = m.offsetWidth, E = m.offsetHeight, y = m.firstChild.nodeObj.branchColor || n, _ = e.generateSubBranch({ pT: c, pL: d, pW: a, pH: u, cT: g, cL: f, cW: v, cH: E, direction: s, isFirst: i });
...
function Xe(e) {
  const t = document.createElement("div"), n = P("tbltl", "left"), o = P("tbltr", "right"), s = P("tblts", "side");
  ...
  for (const i of t)
    if (i)
      for (const r of n)
        i[e](r, o, { capture: !1, ...s });
  return [t, n, o, s];
}, B = Me("addEventListener"), N = Me("removeEventListener"), Y = (e) => {
  var t;
...
class tt extends Je {
  ...
  _bindStartEvents(t = !0) {
    const { document: n, features: o } = this._options, s = t ? B : N;
  ...
  _onTapStart(t, n = !1) {
    ...
    this._scrollDelta = { x: h.scrollLeft, y: h.scrollTop }, this._singleClick = !0, this.clearSelection(!1, !0), B(l, ["touchmove", "mousemove"], this._delayedTapMove, { passive: !1 }), B(l, ["mouseup", "touchcancel", "touchend"], this._onTapStop), B(l, "scroll", this._onScroll);
  }
  _onSingleTap(t) {
  ...
  _recalculateSelectionAreaRect() {
    ...
    const E = me(p, g), y = me(m, f), _ = pe(p, g), w = pe(m, f);
...
const Tt = function(e, t, n, o) {
  ...
  const E = We(`M ${l} ${c} C ${d} ${a} ${u} ${h} ${p} ${m}`, f, v), y = l / 8 + d * 3 / 8 + u * 3 / 8 + p / 8, _ = c / 8 + a * 3 / 8 + h * 3 / 8 + m / 8, w = Tt(o.label, y, _, e.theme.cssVar["--color"]);
...
const Bt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  let g, f;
  const v = p + 10, E = m + 10, y = (v + E) / 2, _ = e.theme.cssVar["--color"];
  a === T.LHS ? (g = ye(`M ${u + 10} ${v} c -5 0 -10 5 -10 10 L ${u} ${E - 10} c 0 5 5 10 10 10 M ${u} ${y} h -10`, _), f = be(o, u - 20, y + 6, "end", _)) : (g = ye(`M ${h - 10} ${v} c 5 0 10 5 10 10 L ${h} ${E - 10} c 0 5 -5 10 -10 10 M ${h} ${y} h 10`, _), f = be(o, h + 20, y + 6, "start", _));
  const w = Ot("s-" + n);
...
const K = 100, nn = '<?xml version="1.0" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">', on = (e, t = !1) => {
  ...
  x(l, {
    ...
    const g = m.cloneNode(!0), { offsetLeft: f, offsetTop: v } = H(n, m.parentElement);
