...
const ut = function(e) {
  ...
  for (let d = 0; d < l.length; d++) {
    ...
    w.tagName === "svg" && w.remove(), a.appendChild(y), Ie(this, y, x, a, m, !0);
  }
...
const gt = (e) => {
  ...
  o.parent ? s.className === t ? xt(e, n) : (r = o.parent) != null && r.parent ? yt(e, n) : bt(e) : t === L.LHS ? gt(e) : vt(e);
}, Le = function(e, t) {
  var r;
...
function wt(e, t) {
  ...
  e.map.onkeydown = (s) => {
    ...
    (s.ctrlKey || s.metaKey) && (s.preventDefault(), s.deltaY < 0 ? ee(e, "in") : e.scaleVal - 0.2 > 0 && ee(e, "out"), s.stopPropagation());
  };
}
...
const Tn = function(e, t, n, o) {
  ...
  b.appendChild(y), b.arrowObj = o, b.dataset.linkid = o.id, e.linkSvgGroup.appendChild(b), s || (e.arrows.push(o), e.currentArrow = b, et(e, o, i, r)), performance.now();
}, An = function(e, t, n = {}) {
  const o = {
    id: U(),
    label: "Custom Link",
