...
const ut = function(e) {
  ...
  for (let h = 0; h < c.length; h++) {
    ...
    if (b) {
      if (b.style.bottom = (b.parentNode.offsetHeight - b.offsetHeight) / 2 + "px", s === L.LHS ? b.style.left = "20px" : s === L.RHS && (b.style.right = "20px"), !b.expanded)
        continue;
    } else
      continue;
    Ie(e, t, w, p, s);
